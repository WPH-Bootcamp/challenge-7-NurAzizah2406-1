...
export const industryTabs: IndustryTab[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&w=800&q=80', // Glowing card mockup
  },
  {
    id: 'ecommerce',
    label: 'E-Commerce',
    ...
    image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80', // Handshake with shopping bags
  },
  {
    id: 'healthcare',
    label: 'Healthcare',
    ...
    image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=800&q=80', // Pill bottle with spilled tablets
  },
];
